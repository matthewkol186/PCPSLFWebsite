...
const Background = () => ( 
    <div>
        <section className="section is-medium" id="background">
            ...
            <div className="container">
                <div className="columns">
                    <div className="column is-one-third">
                        ...
                        <h6 className="subtitle is-size-6 has-margin-t-sm">Source: American Association of Medical Colleges</h6>
                    </div>
                    <div className="column is-two-thirds has-padding-l-lg">
                        ...
                        <p className="is-size-5">
                            By 2030, America is projected to experience <span className="has-text-weight-bold">a shortage of 49,300 primary care physicians (PCPs)</span>.<sup>4</sup> That means that in just 12 years, <span className="has-text-weight-bold">98,000,000 Americans</span>  will lack access to adequate primary care.<sup>5</sup>
                        </p>
                        <p className="is-size-5 has-margin-t-md">
                            We've also seen that the shortage of PCPs is hardest felt by the most vulnerable in our communities. 95% of federally qualified health centers (FQHCs), which provide primary and preventive care underserved areas, <span className="has-text-weight-bold">have at least one clinician vacancy</span>.<sup>6</sup> For many Americans, it's the norm to skip seeing a primary care physician - until it's too late.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="container">
                <div className="columns">
                    <div className="column is-two-thirds has-padding-r-lg">
                        ...
                        <p className="is-size-5">
                            The average medical student graduates with a whopping <span className="has-text-weight-bold">$190,000</span> of debt, a number that's been creeping up year after year.<sup>7</sup> The skyrocketing cost of tuition makes it much harder for graduates to choose primary care instead a more lucrative specialty, like plastic surgery or dermatology.<sup>8</sup> Similarly, doctors are incentivized to work in wealthy districts in metropolitan areas, where they are more likely to find high-paying jobs.<sup>9</sup>
                        </p>
                    </div>
                    <div className="column is-one-third">
