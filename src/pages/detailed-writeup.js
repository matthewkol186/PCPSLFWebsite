  ...
  <div>
    ...
    <section className="section">
      <div className="container">
        ...
        <p className="has-margin-t-md">
            States would also be able to opt in to such a program, allowing states with their own plans to address primary care shortfalls to continue without intervention from the federal government. For example, New York is only projected to require an increase of 8% in its supply of PCPs by 2030. In a case like New York’s, smaller-scale, less expensive interventions may make more sense.  We estimate that modifying the PSLF as such will result in an increase of 25,000 PCPs, closing the gap between demand and supply for PCPs.  
        </p>
